...
- [ ] `Long SL Source` = `LC OR Low`
- [ ] `Short SL Source` = `LC OR High`
- [ ] `Fixed SL Ticks` = `28`
...
- [ ] `Enable TP3` = `On`, `%` = `20`
- [ ] `TP3 Long Level` = `LC Bear IFVG Mid`
- [ ] `TP3 Short Level` = `LC Bull IFVG Mid`
...
- [ ] `L Filter 3 Source` = `LC HTF Bull Pattern Trigger`
...
- [ ] `S Filter 3 Source` = `LC HTF Bear Pattern Trigger`
